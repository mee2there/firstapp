...
public class DataStore {
    /*public static final String[] CHEESES = {
            ...
            "Blue Vein (Australian)", "Blue Vein DataStore", "Bocconcini", "Bocconcini (Australian)",
            ...
            "Manouri", "Manur", "Marble Cheddar", "Marbled DataStore", "Maredsous", "Margotin",
            "Maribo", "Maroilles", "Mascares", "Mascarpone", "Mascarpone (Australian)",
            "Mascarpone Torta", "Matocq", "Maytag Blue", "Meira", "Menallack Farmhouse",
            "Menonita", "Meredith Blue", "Mesost", "Metton (Cancoillotte)", "Meyer Vintage Gouda",
            "Mihalic Peynir", "Milleens", "Mimolette", "Mine-Gabhar", "Mini Baby Bells", "Mixte",
            "Molbo", "Monastery DataStore", "Mondseer", "Mont D'or Lyonnais", "Montasio",
    ...
    DataStore() {
         /*_allEvents = new ArrayList<EventDetailVO>();
         int index = 0;
         for (String item : CHEESES) {
             _allEvents.add(new EventDetailVO(item,index));
             index++;
         }*/
